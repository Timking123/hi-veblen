...
这组 2026-07-11 快照当时的生产证据为 portal `d099480` 的 [CI run `29161853006`](https://github.com/Timking123/hi-veblen/actions/runs/29161853006)、Lingxi `014bdc1` 的 [CI run `29159820620`](https://github.com/Timking123/Lingxi/actions/runs/29159820620)，以及 [production workflow `29162079426`](https://github.com/Timking123/hi-veblen/actions/runs/29162079426)，三者均为 success。当前生产已推进到 portal `3a0b4a9`、Lingxi `0e7383a`，对应 [Portal CI run `29287253837`](https://github.com/Timking123/hi-veblen/actions/runs/29287253837)、[Lingxi CI run `29286909305`](https://github.com/Timking123/Lingxi/actions/runs/29286909305) 和 [production workflow `29299508872`](https://github.com/Timking123/hi-veblen/actions/runs/29299508872)。revision 的推进不改变下表 legacy 计数的历史快照口径。CI 页面上的 `Legacy diagnostics (non-blocking)` success 是非阻断包装的结果：它表示诊断命令已执行并保留结果，不表示下表三个 legacy 检查已经通过。
